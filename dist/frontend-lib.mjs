...
function s(t, e, n, i, r, d, c, l) {
  ...
  if (c ? (h = function(f) {
  ...
  }, o._ssrRegister = h) : r && (h = l ? function() {
    r.call(
      this,
    ...
    if (o.functional) {
      o._injectStyles = h;
      var _ = o.render;
      o.render = function(m, w) {
        return h.call(w), _(m, w);
      };
    } else {
    ...
    makeBold(t, e) {
      ...
      if (c > -1 && r.length) {
        const l = c + r.length - 1, o = (_) => {
          let p = d[_];
          return _ === c && (p = `<b>${p}`), _ === l && (p += "</b>"), p;
        };
        let h = -1;
        return i.replace(/#/g, () => (h += 1, o(h)));
      }
      return t;
    }
  }
...
const ki = wt.exports;
var b = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, kt = { exports: {} };
(function(t, e) {
  (function(n, i) {
    t.exports = i(a);
  })(b, function(n) {
...
var z = pn, fn = typeof b == "object" && b && b.Object === Object && b, _n = fn, Cn = _n, vn = typeof self == "object" && self && self.Object === Object && self, mn = Cn || vn || Function("return this")(), W = mn, gn = W, yn = function() {
  return gn.Date.now();
}, bn = yn, wn = /\s/;
function kn(t) {
  for (var e = t.length; e-- && wn.test(t.charAt(e)); )
    ;
  return e;
}
var $n = kn, xn = $n, Sn = /^\s+/;
...
var Dn = Ln, Mn = W, Vn = Mn.Symbol, Y = Vn, I = Y, E = Object.prototype, In = E.hasOwnProperty, On = E.toString, y = I ? I.toStringTag : void 0;
function Pn(t) {
...
var Qn = Jn, Un = Dn, H = z, Xn = Qn, B = 0 / 0, e1 = /^[-+]0x[0-9a-f]+$/i, t1 = /^0b[01]+$/i, n1 = /^0o[0-7]+$/i, i1 = parseInt;
function s1(t) {
  if (typeof t == "number")
    return t;
  if (Xn(t))
  ...
  t = Un(t);
  var n = t1.test(t);
  return n || n1.test(t) ? i1(t.slice(2), n ? 2 : 8) : e1.test(t) ? B : +t;
}
var r1 = s1, a1 = z, x = bn, T = r1, o1 = "Expected a function", l1 = Math.max, c1 = Math.min;
function d1(t, e, n) {
  var i, r, d, c, l, o, h = 0, _ = !1, p = !1, f = !0;
  if (typeof t != "function")
    throw new TypeError(o1);
  e = T(e) || 0, a1(n) && (_ = !!n.leading, p = "maxWait" in n, d = p ? l1(T(n.maxWait) || 0, e) : d, f = "trailing" in n ? !!n.trailing : f);
  function m(u) {
    var C = i, g = r;
    return i = r = void 0, h = u, c = t.apply(g, C), c;
  }
  function w(u) {
    return h = u, l = setTimeout(k, e), _ ? m(u) : c;
  }
  function K(u) {
    var C = u - o, g = u - h, D = e - C;
    return p ? c1(D, d - g) : D;
  }
  function S(u) {
    var C = u - o, g = u - h;
    return o === void 0 || C >= e || C < 0 || p && g >= d;
  }
  function k() {
    var u = x();
    if (S(u))
  ...
  function G() {
    l !== void 0 && clearTimeout(l), h = 0, i = o = r = l = void 0;
  }
  function J() {
  ...
  function $() {
    var u = x(), C = S(u);
    if (i = arguments, r = this, o = u, C) {
      if (l === void 0)
        return w(o);
      if (p)
        return clearTimeout(l), l = setTimeout(k, e), m(o);
    }
    return l === void 0 && (l = setTimeout(k, e)), c;
  }
...
const h1 = {
  ...
  methods: {
    ...
    debouncedHandleQuery: u1(function() {
...
const Fi = ci.exports, di = {
  name: "IcLightbulbOn"
};
var ui = function() {
  var e = this, n = e._self._c;
  return n("svg", { attrs: { width: "25", height: "26", viewBox: "0 0 25 26", fill: "none", xmlns: "http://www.w3.org/2000/svg" } }, [n("g", [n("path", { attrs: { d: "M9.99023 21.3008L10.1242 23.5269L10.5882 24.5365L12.5395 24.9436L14.4422 24.403L15.0552 23.4017L15.0988 20.9637L9.99023 21.3008Z", fill: "currentColor" } }), n("path", { attrs: { d: "M12.5392 25.4444C9.50929 25.4444 9.49924 23.5254 9.48752 21.4929V21.3043C9.47579 19.6223 8.94987 18.9781 8.85105 18.8714L8.81252 18.8413C6.0623 16.697 5.59667 14.5844 5.54475 14.3024C5.40405 13.7384 5.33203 13.1577 5.33203 12.572C5.33203 8.63545 8.54621 5.43152 12.499 5.43152C16.4519 5.43152 19.666 8.63545 19.666 12.572C19.666 13.131 19.6007 13.6867 19.4734 14.2256C19.4282 14.5627 19.0396 16.7321 16.2609 18.8447L16.2291 18.868C16.1353 18.9681 15.6027 19.6089 15.5909 21.3027V21.4912C15.5792 23.5237 15.5675 25.4428 12.5376 25.4428L12.5392 25.4444ZM9.43057 18.0553C9.85265 18.3574 10.4791 19.3486 10.4925 21.2977V21.4879C10.5059 23.5788 10.5092 24.4432 12.5409 24.4432C14.5726 24.4432 14.5759 23.5771 14.5877 21.4879V21.2977C14.6011 19.3403 15.2342 18.349 15.6546 18.052H15.6529C18.2357 16.0846 18.4768 14.1072 18.4802 14.0871L18.4919 14.0204C18.6058 13.5498 18.6644 13.0626 18.6644 12.5736C18.6644 9.1878 15.9008 6.43442 12.5024 6.43442C9.10396 6.43442 6.34034 9.1878 6.34034 12.5736C6.34034 13.0826 6.40231 13.5899 6.52625 14.0788L6.53463 14.1239C6.543 14.1706 6.89976 16.0796 9.43225 18.0553H9.43057Z", fill: "currentColor" } }), n("path", { attrs: { d: "M15.0548 21.5618H10.1238C9.89267 21.5618 9.70508 21.3749 9.70508 21.1446C9.70508 20.9143 9.89267 20.7274 10.1238 20.7274H15.0548C15.2859 20.7274 15.4735 20.9143 15.4735 21.1446C15.4735 21.3749 15.2859 21.5618 15.0548 21.5618Z", fill: "currentColor" } }), n("path", { attrs: { d: "M15.056 16.4913H9.94584C9.6678 16.4913 9.44336 16.2677 9.44336 15.9907C9.44336 15.7137 9.6678 15.4901 9.94584 15.4901H15.056C15.3341 15.4901 15.5585 15.7137 15.5585 15.9907C15.5585 16.2677 15.3341 16.4913 15.056 16.4913Z", fill: "currentColor" } }), n("path", { attrs: { d: "M12.5005 21.6443C12.2225 21.6443 11.998 21.4207 11.998 21.1437V15.9907C11.998 15.7137 12.2225 15.4901 12.5005 15.4901C12.7786 15.4901 13.003 15.7137 13.003 15.9907V21.1437C13.003 21.4207 12.7786 21.6443 12.5005 21.6443Z", fill: "currentColor" } }), n("path", { attrs: { d: "M12.5005 4.2651C12.2225 4.2651 11.998 4.04149 11.998 3.76448V1.05616C11.998 0.77915 12.2225 0.555542 12.5005 0.555542C12.7786 0.555542 13.003 0.77915 13.003 1.05616V3.76448C13.003 4.04149 12.7786 4.2651 12.5005 4.2651Z", fill: "currentColor" } }), n("path", { attrs: { d: "M5.80078 7.3759C5.71536 7.3759 5.62994 7.3542 5.54954 7.30915L4.37207 6.63165L3.1946 5.95415C3.03381 5.8607 2.94336 5.69216 2.94336 5.52029C2.94336 5.43518 2.96513 5.35008 3.01036 5.26998C3.14938 5.03135 3.45589 4.94792 3.69708 5.08642L6.05034 6.44142C6.21114 6.53487 6.30158 6.70174 6.30158 6.87528C6.30158 6.96039 6.27981 7.04549 6.23459 7.12559C6.14079 7.28579 5.9733 7.3759 5.79911 7.3759H5.80078Z", fill: "currentColor" } }), n("path", { attrs: { d: "M3.72088 13.1543H1.00248C0.72444 13.1543 0.5 12.9307 0.5 12.6537C0.5 12.3767 0.72444 12.1531 1.00248 12.1531H3.72088C3.99892 12.1531 4.22336 12.3767 4.22336 12.6537C4.22336 12.9307 3.99892 13.1543 3.72088 13.1543Z", fill: "currentColor" } }), n("path", { attrs: { d: "M23.9982 13.1544H21.2798C21.0018 13.1544 20.7773 12.9308 20.7773 12.6538C20.7773 12.3768 21.0018 12.1532 21.2798 12.1532H23.9982C24.2763 12.1532 24.5007 12.3768 24.5007 12.6538C24.5007 12.9308 24.2763 13.1544 23.9982 13.1544Z", fill: "currentColor" } }), n("path", { attrs: { d: "M19.1997 7.37557C19.0256 7.37557 18.8581 7.28546 18.7643 7.12526C18.719 7.04683 18.6973 6.96006 18.6973 6.87495C18.6973 6.70141 18.7877 6.53287 18.9485 6.44109L21.3018 5.08776C21.543 4.94926 21.8495 5.03102 21.9885 5.27132C22.0337 5.34975 22.0555 5.43652 22.0555 5.52163C22.0555 5.69517 21.965 5.86371 21.8043 5.95549L20.6268 6.63299L19.4493 7.31049C19.3706 7.35554 19.2835 7.37724 19.1981 7.37724L19.1997 7.37557Z", fill: "currentColor" } }), n("path", { attrs: { d: "M17.1112 12.9879C17.0945 12.9879 17.0777 12.9879 17.061 12.9862C16.7846 12.9595 16.5819 12.7142 16.6104 12.4388C16.8667 9.83732 14.2337 8.73597 14.2069 8.72429C13.9506 8.61916 13.8267 8.32713 13.9322 8.07182C14.0377 7.81651 14.3308 7.69302 14.5871 7.79815C15.7478 8.2704 17.8733 9.86736 17.6103 12.5373C17.5852 12.796 17.3658 12.9895 17.1112 12.9895V12.9879Z", fill: "currentColor" } })])]);
}, hi = [], pi = /* @__PURE__ */ s(
  di,
  ui,
  hi,
