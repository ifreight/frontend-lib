...
var ns = ss, as = E, rs = as.Symbol, z = rs, A = z, K = Object.prototype, ls = K.hasOwnProperty, os = K.toString, y = A ? A.toStringTag : void 0;
function cs(t) {
...
var Ds = Ss, Is = ns, R = q, Ms = Ds, j = 0 / 0, Ls = /^[-+]0x[0-9a-f]+$/i, Vs = /^0b[01]+$/i, Os = /^0o[0-7]+$/i, Ps = parseInt;
function Ts(t) {
  if (typeof t == "number")
    return t;
  if (Ms(t))
      ...
      const e = [], i = [], s = Array.from(t.target.files).map(async (n, l) => {
        if (this.limit)
          if (l + this.selectedFile.length <= this.limit - 1)
            ...
            this.$emit("invalidLimit", n);
        else if (n.size <= this.maxSize * 1024) {
          const o = await this.processingFile(n);
          i.push(o), this.$emit("input", this.value.concat(o));
        } else
          e.push(n);
