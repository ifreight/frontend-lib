...
function r(t, e, i, n, s, c, u, o) {
  ...
  }, l._ssrRegister = p) : s && (p = o ? function() {
    s.call(
      this,
...
const it = {
  ...
  methods: {
    makeBold(t, e) {
      ...
      let i = e;
      i == null && ({ query: i } = this);
      const n = t.replace(/\w/g, "#"), s = i.toLowerCase().replace(/\W/g, ""), c = t.replace(/\W/g, ""), u = c.toLowerCase().indexOf(s);
      if (u > -1 && s.length) {
        const o = u + s.length - 1, l = (_) => {
          let h = c[_];
...
var nt = function() {
  ...
  return i("i-dropdown", { staticClass: "i-dropdown-options", attrs: { visible: e.visible, width: e.width } }, [e.$slots.header ? i("div", { staticClass: "i-dropdown-options-header" }, [e._t("header")], 2) : e._e(), e.filteredOptions.length > 0 ? i("ul", { staticClass: "i-dropdown-options-body" }, e._l(e.filteredOptions, function(n, s) {
    return i("li", { key: `option-${s}`, class: e.currentValue === n[e.optionKey] && "selected", on: { click: function(c) {
...
var q = xi, Si = typeof b == "object" && b && b.Object === Object && b, Vi = Si, Di = Vi, Li = typeof self == "object" && self && self.Object === Object && self, Ii = Di || Li || Function("return this")(), E = Ii, Mi = E, Oi = function() {
  return Mi.Date.now();
}, Pi = Oi, Ti = /\s/;
function Bi(t) {
...
var Hi = Bi, Ai = Hi, Fi = /^\s+/;
function Ri(t) {
  return t && t.slice(0, Ai(t) + 1).replace(Fi, "");
}
var Ni = Ri, ji = E, Zi = ji.Symbol, z = Zi, P = z, W = Object.prototype, qi = W.hasOwnProperty, Ei = W.toString, y = P ? P.toStringTag : void 0;
function zi(t) {
...
var Ji = Gi, T = z, Qi = Wi, Ui = Ji, Xi = "[object Null]", en = "[object Undefined]", B = T ? T.toStringTag : void 0;
function tn(t) {
  return t == null ? t === void 0 ? en : Xi : B && B in Object(t) ? Qi(t) : Ui(t);
}
var nn = tn;
function sn(t) {
...
var un = cn, dn = Ni, H = q, pn = un, A = 0 / 0, hn = /^[-+]0x[0-9a-f]+$/i, fn = /^0b[01]+$/i, _n = /^0o[0-7]+$/i, vn = parseInt;
function mn(t) {
  if (typeof t == "number")
    return t;
  if (pn(t))
  ...
  t = dn(t);
  var i = fn.test(t);
  return i || _n.test(t) ? vn(t.slice(2), i ? 2 : 8) : hn.test(t) ? A : +t;
}
var Cn = mn, gn = q, x = Pi, F = Cn, yn = "Expected a function", bn = Math.max, kn = Math.min;
function wn(t, e, i) {
  var n, s, c, u, o, l, p = 0, _ = !1, h = !1, f = !0;
  if (typeof t != "function")
    throw new TypeError(yn);
  e = F(e) || 0, gn(i) && (_ = !!i.leading, h = "maxWait" in i, c = h ? bn(F(i.maxWait) || 0, e) : c, f = "trailing" in i ? !!i.trailing : f);
  function C(d) {
    var v = n, g = s;
    return n = s = void 0, p = d, u = t.apply(g, v), u;
  }
  function k(d) {
    return p = d, o = setTimeout(w, e), _ ? C(d) : u;
  }
  function Y(d) {
    var v = d - l, g = d - p, I = e - v;
    return h ? kn(I, c - g) : I;
  }
  function D(d) {
    var v = d - l, g = d - p;
  ...
  function L(d) {
    return o = void 0, f && n ? C(d) : (n = s = void 0, u);
  }
  function K() {
    o !== void 0 && clearTimeout(o), p = 0, n = l = s = o = void 0;
  }
  function G() {
  ...
  function $() {
    var d = x(), v = D(d);
    if (n = arguments, s = this, l = d, v) {
      if (o === void 0)
        return k(l);
      if (h)
        return clearTimeout(o), o = setTimeout(w, e), C(l);
    }
...
var Qn = function() {
  ...
  return i("div", { staticClass: "i-input-tag", class: e.classes }, [e.label ? i("div", { staticClass: "i-input-tag-label" }, [i("label", [e._v(e._s(e.label))])]) : e._e(), i("div", { staticClass: "i-input-tag-body" }, [e._l(e.value, function(n, s) {
    return i("i-tag", { key: `input-tag-${s}`, attrs: { closable: "" }, on: { close: function(c) {
      return e.onRemove(n);
    } } }, [e._v(" " + e._s(n) + " ")]);
    ...
    var s = e.inputValue, c = n.target, u = !!c.checked;
    if (Array.isArray(s)) {
      var o = null, l = e._i(s, o);
      c.checked ? l < 0 && (e.inputValue = s.concat([o])) : l > -1 && (e.inputValue = s.slice(0, l).concat(s.slice(l + 1)));
    } else
      e.inputValue = u;
